...
class AizUploadController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->user_id != null) {
            ...
            $all_uploads = Upload::where('user_id',$user_id);
        }
        else
        {
        ...
        if (auth()->user()->user_type == 'seller') {
            ...
            return view('courier.uploads.index', compact('all_uploads', 'search', 'sort_by'));
        } else {
            return view('backend.uploaded_files.index', compact('all_uploads', 'search', 'sort_by', 'users', 'user_id'));
        }
    ...
    public function create()
    {
        if (auth()->user()->user_type == 'seller') {
            ...
            return view('courier.uploads.create');
        } else {
    ...
    public function upload(Request $request)
    {
        ...
        if ($request->hasFile('aiz_file')) {
            ...
            if (isset($type[$extension])) {
                ...
                $media_folder = Auth::user()->media_folder;
                $storage_path = $media_folder ? 'uploads/' . $media_folder : 'uploads/all';
                $path = $request->file('aiz_file')->store($storage_path, 'local');

...
use App\Models\AuctionProductsExport;
use PDF;
...
class ProductBulkUploadController extends Controller
{
    public function __construct() {
        ...
        $this->middleware(['permission:auction_product_bulk_import'])->only('auction_product_bulk_import');
        $this->middleware(['permission:auction_product_export'])->only('auction_product_export');
    ...
    public function auction_product_bulk_import()
    {
        if (Auth::user()->user_type == 'seller') {
            if(Auth::user()->shop->verification_status){
                return view('seller.product_bulk_upload.index');
    ...
    public function auction_product_export(){
        return Excel::download(new AuctionProductsExport, 'products.xlsx');
    }

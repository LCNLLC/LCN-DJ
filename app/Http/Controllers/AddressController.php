...
class AddressController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->has('delivery_destination')){
            $address->delivery_destination   = $request->delivery_destination;
        }
        if($request->has('placement_specification')){
            $address->placement_specification   = $request->placement_specification;
        }

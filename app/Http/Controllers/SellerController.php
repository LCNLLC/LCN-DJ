...
class SellerController extends Controller
{
    ...
    {
        $shop = Shop::findOrFail($id);
        SellerAccountStatusBanUnbendDeleteNotification($shop->user_id,'deleted');
    ...
    public function updateApproved(Request $request)
    {
        ...
        if ($shop->save()) {
            SellerAccountStatusNotification($shop->user_id,$request->status);
            Cache::forget('verified_sellers_id');
            return 1;
        }
        return 0;
    ...
    public function ban($id)
    {
        ...
        $shop->user->save();
        SellerAccountStatusBanUnbendDeleteNotification($shop->user_id,$status);
        return back();
    }
}

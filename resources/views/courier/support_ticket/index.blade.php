                  ...
                  <tbody>
                      @foreach ($tickets as $key => $ticket)
                          <tr>
                              ...
                              <td>
                                  <a href="{{route('courier.support_ticket.show', encrypt($ticket->id))}}" class="btn btn-styled btn-link py-1 px-0 icon-anim text-underline--none">
        ...
        <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body px-3 pt-3">
                  <form class="" action="{{ route('courier.support_ticket.store') }}" method="post" enctype="multipart/form-data">
                      @csrf
                      <div class="row">
                          <div class="col-md-2">

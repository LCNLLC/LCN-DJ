...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		...
		<div class="col-md-6 text-md-right">
			<a href="{{ route('courier.uploads.create') }}" class="btn btn-primary">
...
@section('script')
	<script type="text/javascript">
		function detailsInfo(e){
			...
			$.post('{{ route('courier.my_uploads.info') }}', {_token: AIZ.data.csrf, id:id}, function(data){
		...
		function bulk_delete() {
            ...
            $.ajax({
                ...
                url: "{{route('courier.bulk-uploaded-files-delete')}}",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,

                 ...
                 <div class="form-group row" >
                    ...
                    <div class="col-md-10">
                        <select class="form-control aiz-selectpicker" name="language" >
                            ...
                            <option value="{{ $lang->code }}" @if($lang->code == $user->language ) selected
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="cash_on_delivery_status" type="checkbox" @if ($user->courier->cash_on_delivery_status == 1) checked @endif>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="bank_payment_status" type="checkbox" @if ($user->courier->bank_payment_status == 1) checked @endif>
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_name" value="{{ $user->courier->bank_name }}" id="bank_name" class="form-control mb-3" placeholder="{{ translate('Bank Name')}}">
                        @error('phone')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_acc_name" value="{{ $user->courier->bank_acc_name }}" id="bank_acc_name" class="form-control mb-3" placeholder="{{ translate('Bank Account Name')}}">
                        @error('bank_acc_name')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_acc_no" value="{{ $user->courier->bank_acc_no }}" id="bank_acc_no" class="form-control mb-3" placeholder="{{ translate('Bank Account Number')}}">
                        @error('bank_acc_no')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="number" name="bank_routing_no" value="{{ $user->courier->bank_routing_no }}" id="bank_routing_no" lang="en" class="form-control mb-3" placeholder="{{ translate('Bank Routing Number')}}">

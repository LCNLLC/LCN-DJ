    ...
    <table class="table aiz-table mb-0">
        <thead>
            <tr>
                ...
                <th data-breakpoints="md">{{ translate('Delivery Charges')}}</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">
                    <a href="{{ route('courier.orders.show', encrypt($order->id)) }}" class="btn btn-soft-info btn-icon btn-circle btn-sm" title="{{ translate('Order Details') }}">
                        <i class="las la-eye"></i>
                    </a>
                    <a class="btn btn-soft-success btn-icon btn-circle btn-sm" href="{{ route('courier.invoice.print', $order->id) }}" title="{{ translate('Print Invoice') }}">
                        <i class="las la-print"></i>
                    </a>
                    <a href="{{ route('courier.invoice.download', $order->id) }}" class="btn btn-soft-warning btn-icon btn-circle btn-sm" title="{{ translate('Download Invoice') }}">

                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <h3 class="mb-0 text-white fs-30">
                            {{ \App\Models\Order::where('courier_id', Auth::user()->id)->where('delivery_status', 'delivered')->count() }}
                        </h3>
                    </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                        <p class="small text-muted mb-0">
                            <span class="fe fe-arrow-down fe-12"></span>
                            <span class="fs-14 text-light">{{ translate('Total Balance') }}</span>
                        </p>
                        <h3 class="mb-0 text-white fs-30">
                            @php
                    ...
                    @endphp
                    {{ single_price( admin_pay_to_courier(Auth::user()->id)) }}
                </h3>
...
<div class="row">
    <div class="col-sm-6 col-md-6 col-lg-4 mb-4">
                ...
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col">
                        ...
                        <h3 class="mb-0" style="color: #A9A3CC">
                           ...
                           {{ \App\Models\Order::where('courier_id', Auth::user()->id)
        ...
        <div class="col">
            ...
            <h3 class="mb-0" style="color: #A9A3CC">
             {{ \App\Models\OrderDetail::join('orders', 'order_details.order_id', '=', 'orders.id')
             ->where('orders.courier_id', Auth::user()->id)
             ->where('order_details.delivery_status', 'cancelled')
             ->count() }}
         </h3>
     </div>
 </div>
 <div class="row align-items-center mb-4">
    ...
    <div class="col">
        ...
        <h3 class="mb-0" style="color: #A9A3CC">
            ...
            {{ \App\Models\OrderDetail::join('orders', 'order_details.order_id', '=', 'orders.id')
            ->where('orders.courier_id', Auth::user()->id)
            ->where('order_details.delivery_status', 'on_the_way')
            ->count() }}
...
<div class="col-sm-6 col-md-6 col-lg-4 mb-4">
    <div class="card h-450px mb-0 h-100">
        ...
        $orderTotal = \App\Models\Order::where('courier_id', Auth::user()->id)
        ->where('delivery_status', 'delivered')
        ->where('created_at', '>=', $days_ago_30)
        ->sum('courier_shipping_cost');
        @endphp
        ...
        <div class="card-body">
            ...
            <p>{{ translate('Your Earning (Current month)') }}</p>
...
<div class="row">
    <div class="col-sm-6 col-md-6 col-lg-3">
        ...
        <div class="fs-16 fw-600 text-white">
...
<div class="col-sm-6 col-md-6 col-lg-3">
    ...
    <a href="{{ route('courier.profile.index') }}" class="btn btn-primary">

        ...
        <div class="col-md-6 text-right">
            @can('create_customer')
                <a href="{{ route('customers.create') }}" class="btn btn-primary">
                    <i class="las la-plus"></i> {{ translate('Add New Customer') }}
                </a>
            @endcan
        </div>
    </div>
                ...
                <tbody>
                    @forelse($users as $key => $user)
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                @can('edit_customer')
                                    <a href="{{ route('customers.edit', $user->id) }}" class="btn btn-soft-info btn-icon btn-circle btn-sm" title="{{ translate('Edit') }}">

...
<body>
			...
			<table>
				...
				<tr>
					<td class="gry-color small">
						{{ translate('Delivery Destination') }}:
						@if(isset($shipping_address->delivery_destination))
						{{ translate($shipping_address->delivery_destination) }}
						@else
				...
				<tr>
					<td class="gry-color small">
						{{ translate('Placement Specification') }}:
						@if(isset($shipping_address->placement_specification))
						{{ translate($shipping_address->placement_specification) }}
						@else
						<!-- {{ translate('Not specified') }} -->
						@endif
					</td>
	...
	<div style="margin-top: 20px;margin-bottom: 20px; text-align: center;">
		<button onclick="window.print()">{{ translate('Print Invoice') }}</button>
	</div>
</body>
</html>

...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Add New Job')}}</h5>
</div>
<div class="">
    <!-- Error Meassages -->
    @if ($errors->any())
    ...
    @endif
    <form class="form form-horizontal mar-top" action="{{route('job.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="{{ translate('Job Title') }}" required>
                            </div>
                        </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
          <input type="text" class="form-control" name="latitude" value="" placeholder="Ex: 1.462260">
   ...
   <div class="form-group row">
    ...
    <div class="col-md-8">
        <input type="text" class="form-control" name="longitude" value="" placeholder="Ex: 1.462260">
        <small class="text-muted">
            <a class="help-block" href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank" rel="nofollow">
   ...
   <div class="form-group row">
    ...
    <div class="col-md-8">
        <input type="text" class="form-control" name="salary_from" value="{{old('salary_from')}}" placeholder="{{ translate('Salary from') }}" >
    </div>
</div>
<div class="form-group row">
    <label class="col-md-3 col-from-label">{{translate('Salary To')}}</label>
    <div class="col-md-8">
        <input type="text" class="form-control" name="salary_to" value="{{old('salary_to')}}" placeholder="{{ translate('Salary to') }}" >
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-md-8">
     <input type="date" class="form-control" value="" name="application_closing_date">
 </div>
</div>
<div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="form-group col-md-12">
                      <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="job_shift_id" >
                        ...
                        <option value="{{ $shift->id }}">{{ $shift->getTranslation('name') }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="form-group col-md-12">
                  <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="career_level_id" >
                    ...
                    <option value="{{ $career_level->id }}">{{ $career_level->getTranslation('name') }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            <div class="form-group col-md-12">
              <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="functional_area_id" >
                ...
                <option value="{{ $functional_area->id }}">{{ $functional_area->getTranslation('name') }}</option>
                @endforeach
            </select>
        </div>
    </div>
        ...
        <div class="form-group row">
            <div class="form-group col-md-12">
              <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="degree_level_id" >
                ...
                <option value="{{ $degree_level->id }}">{{ $degree_level->getTranslation('name') }}</option>
                @endforeach
            </select>
        </div>
    </div>
        ...
        <div class="form-group row">
            <div class="form-group col-md-12">
              <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="job_experience_id" >
                ...
                <option value="{{ $experience->id }}">{{ $experience->getTranslation('name') }}</option>
                @endforeach
            </select>
        </div>
    </div>

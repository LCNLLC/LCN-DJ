    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                <img class="mw-100" src="{{ uploaded_asset(get_setting('system_logo_white')) }}" class="brand-icon" alt="{{ get_setting('site_name') }}" style="filter: brightness(200) saturate(0%);">
                @else
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['customers.payment_history']) }}">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                               <a href="{{ route('referral.index') }}" class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">{{translate('Referral Levels')}}</span>
                            </a>
                        </li>

                        @can('customer_payment_history')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customers.payment_histories') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customers.payment_history']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Payouts') }}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_customer_payout_requests')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customer_withdraw_requests_all') }}" class="aiz-side-nav-link">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @can('show_all_products')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('products.boost')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('All Boosting Products') }}</span>
                            </a>
                        </li>
                        @endcan
                ...
                @canany(['add_auction_product','view_all_auction_products','auction_product_bulk_import','auction_product_export','view_inhouse_auction_products','view_seller_auction_products','view_auction_product_orders'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('auction.inhouse_products')}}" class="aiz-side-nav-link {{ areActiveRoutes(['auction.bids']) }}">
                        ...
                        @can('product_bulk_import')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('auction_product_bulk_import') }}" class="aiz-side-nav-link" >
                                <span class="aiz-side-nav-text">{{ translate('Bulk Import') }}</span>
                            </a>
                        </li>
                        @endcan
                        @can('product_bulk_export')
                        <li class="aiz-side-nav-item">
                            <a href="{{route('auction_product_export')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Bulk Export')}}</span>
                            </a>
                        </li>
                        @endcan
                ...
                @canany(['seller_donated_product', 'admin_donated_product'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-luggage-cart aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Products Donation')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        @can('create_package')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('products.admin.donate') }}" class="aiz-side-nav-link {{ areActiveRoutes(['products.admin.donate'])}}">
                                <span class="aiz-side-nav-text">{{translate('Admin Donated Products')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_package')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('products.seller.donate') }}" class="aiz-side-nav-link {{ areActiveRoutes(['products.seller.donate'])}}" >
                                <span class="aiz-side-nav-text">{{translate('Sellers Donated Products')}}</span>
                            </a>
                        </li>
                        @endcan
                    </ul>
                ...
                <!-- Sale -->
                @canany(['view_all_orders', 'view_inhouse_orders','view_seller_orders','view_pickup_point_orders','export_orders','view_export_sale_report','view_tax_report'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @can('view_export_sale_report')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('all_orders.export') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.export', 'all_orders.show'])}}">
                                <span class="aiz-side-nav-text">{{translate('Export Sale Report')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_tax_report')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('sale.tax.report') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sale.tax.report'])}}">
                                <span class="aiz-side-nav-text">{{translate('Tax Report')}}</span>
                            </a>
                        </li>
                        @endcan
                ...
                @endcanany
                <!-- Sale -->
                @canany(['create_package', 'view_all_package'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-money-bill aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Products Marketing Plan')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        @can('create_package')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('package.create') }}" class="aiz-side-nav-link {{ areActiveRoutes(['package.create'])}}">
                                <span class="aiz-side-nav-text">{{translate('Create Package')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_package')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('package.show') }}" class="aiz-side-nav-link {{ areActiveRoutes(['package.show'])}}" >
                ...
                <!-- Sale -->
                @canany(['discount_day','view_all_flash_deals'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-money-bill aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Discount Setting')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        @can('create_package')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('discount_day.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['discount_day.index','discount_day.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Discount Days')}}</span>
                            </a>
                        </li>
                        @endcan
                ...
                @canany(['view_all_candidates'])
                <li class="aiz-side-nav-item" >
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-user-friends aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Candidates') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        @can('view_all_candidates')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('candidates.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Candidates list') }}</span>
                            </a>
                        </li>
                        @endcan
                    </ul>
                ...
                <!-- Courier -->
                @canany(['view_all_courier','courier_payment_history','view_courier_payout_requests','courier_commission_configuration','courier_commission'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="la la-automobile aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Couriers') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        @can('view_all_courier')
                        <li class="aiz-side-nav-item">
                            @php
                            $sellers = \App\Models\Courier::where('verification_status', 0)->where('verification_info', '!=', null)->count();
                            @endphp
                            <a href="{{ route('couriers.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['couriers.index', 'couriers.create', 'couriers.edit', 'couriers.payment_history','couriers.approved','couriers.profile_modal','couriers.show_verification_request'])}}">
                                <span class="aiz-side-nav-text">{{ translate('All Couriers') }}</span>
                                @if($sellers > 0)<span class="badge badge-info">{{ $sellers }}</span> @endif
                            </a>
                        </li>
                        @endcan
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('couriers.payment_histories') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Payouts') }}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_courier_payout_requests')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('courier_withdraw_requests_all') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Payout Requests') }}</span>
                            </a>
                        </li>
                        @endcan
                        @can('courier_commission_configuration')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('business_settings.courier_commission') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Courier Commission') }}</span>
                            </a>
                        </li>
                        @endcan
                ...
                @endcanany
                <!-- Job system -->
                @canany(['view_all_job_type', 'admin_donated_product'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-briefcase aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Job Board')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        @can('create_package')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job','job.edit','job.create','job.company.analytics'])}}">
                        ...
                        @can('view_all_package')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.application') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.application','job.application.edit','job.application.analytics'])}}" >
                                <span class="aiz-side-nav-text">{{translate('Job Applications')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_company')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.company') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.company','job.company.edit'])}}" >
                                <span class="aiz-side-nav-text">{{translate('Job Companies')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_job_type')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.type') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.type','job.type.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Job Types')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_job_skill')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.skill') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.skill','job.skill.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Job Skills')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_job_shift')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.shift') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.shift','job.shift.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Job Shifts')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_job_experience')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.experience') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.experience','job.experience.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Job Experiences')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_job_level')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.level') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.level','job.level.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Job Levels')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_job_career_level')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.career.level') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.career.level','job.career.level.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Career Levels')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_job_functional_area')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('job.functional.area') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.functional.area','job.functional.area.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Functional Areas')}}</span>
                            </a>
                        </li>
                        @endcan
                          <!--   @can('view_all_job_category')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('job.category') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.category','job.category.edit'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Job Categories')}}</span>
                                    </a>
                                </li>
                                @endcan -->
                                @can('view_all_job_degree_level')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('job.degree.level') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.degree.level','job.degree.level.edit'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Degree Levels')}}</span>
                                    </a>
                                </li>
                                @endcan
                                @can('create_package')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('job.degree.type') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.degree.type','job.degree.type.edit'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Degree Types')}}</span>
                                    </a>
                                </li>
                                @endcan
                            </ul>
                        ...
                        <!-- Support -->
                        @canany(['view_all_support_tickets','view_all_product_conversations','view_all_product_queries','view_all_idea'])
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @endphp
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('idea.admin_index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['idea.admin_index', 'idea.admin_show'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Evolution Idea')}}</span>
                                        @if($ideas > 0)<span class="badge badge-info">{{ $ideas }}</span>@endif
                                    </a>
                                </li>
                                @endcan
                    ...
                    <!-- Website Setup -->
                    @canany(['header_setup','footer_setup','view_all_website_pages','website_appearance','slider_setup','faq'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('slider_setup')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('website.slider') }}" class="aiz-side-nav-link">
                            ...
                            @can('faq')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('faq.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['faq.index','faq.create','faq.edit','faq.show','faq.edit'])}}">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('vat_&_tax_setup')
                            <li class="aiz-side-nav-item">
                                <a href="{{route('tax-value.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['tax-value.index', 'tax.create', 'tax.store', 'tax.show', 'tax.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('TAX Values')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            @endcan
                            @can('product_price_adjustment')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('product_price_adjustment.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Product Price Adjustment')}}</span>
                                </a>
                            </li>
                            @endcan
                            @can('shipping_cost_adjustment')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('shipping_cost_adjustment.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Shipping Cost Adjustment')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            <li class="aiz-side-nav-item" style="display: none;">
                                ...
                                <ul class="aiz-side-nav-list level-3">
                                    ...
                                    @endcanany
                                    @canany(['shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers','shipping_cost_size'])
                                    <li class="aiz-side-nav-item">
                                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                                        ...
                                        <ul class="aiz-side-nav-list level-3">
                                            ...
                                            @endcan
                                            @can('shipping_cost_size')
                                            <li class="aiz-side-nav-item">
                                                <a href="{{route('shipping_cost_size.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['shipping_cost_size.index','shipping_cost_size.edit','shipping_cost_size.update','shipping_cost_size.create'])}}">
                            ...
                            @endcanany
                            <!-- Email tranlation -->
                            @canany(['view_email_lang','view_email_template'])
                            <li class="aiz-side-nav-item">
                                <a href="#" class="aiz-side-nav-link">
                                    <i class="las la-envelope aiz-side-nav-icon"></i>
                                    <span class="aiz-side-nav-text">{{ translate('Email Settings') }}</span>
                                    <span class="aiz-side-nav-arrow"></span>
                                </a>
                                <ul class="aiz-side-nav-list level-2">
                                    @can('view_blogs')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('email.language.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['email.language.index','email.language.edit','add.email.language'])}}">
                                            <span class="aiz-side-nav-text">{{ translate('Email Language Manager') }}</span>
                                        </a>
                                    </li>
                                    @endcan
                                    @can('view_blog_categories')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('general.email') }}" class="aiz-side-nav-link {{ areActiveRoutes(['general.email', 'general.email'])}}">
                                            <span class="aiz-side-nav-text">{{ translate('Email Template') }}</span>
                                        </a>
                                    </li>
                                    @endcan
                                </ul>
                            ...
                            <li class="aiz-side-nav-item">
                                ...
                                @endcan
                                {{--  <li class="aiz-side-nav-item">
                                    <a href="./admin/log-reader" class="aiz-side-nav-link treeview-item @if(request()->path() == 'admin/log-reader') active @endif">
                                        {{translate('Activities Log')}}
                                    </a>
                                </li>  --}}
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('system.cache')}}" class="aiz-side-nav-link treeview-item @if(request()->path() == 'admin/cache') active @endif">
                                        {{translate('System Cache')}}
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('system.information')}}" class="aiz-side-nav-link treeview-item @if(request()->path() == 'admin/system/information') active @endif">
                        ...
                        {{--  @can('view_upload_file')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customer.search') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.customer.search'])}}">
                                    <i class="las la-search aiz-side-nav-icon"></i>
                                    <span class="aiz-side-nav-text">{{ translate('Customers Searches') }}</span>
                                </a>
                            </li>
                        @endcan  --}}

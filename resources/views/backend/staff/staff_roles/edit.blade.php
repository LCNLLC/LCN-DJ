            ...
            <form class="p-4" action="{{ route('roles.update', $role->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                     ...
                     <label class="col-md-3 col-from-label" for="description">{{translate('Description')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-md-9">
                        <input type="text" placeholder="{{translate('Description')}}" id="description" name="description" class="form-control" value="{{ $roleForTranslation->getTranslation('description', $lang) }}" required>
                    </div>
                </div>

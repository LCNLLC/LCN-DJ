            ...
            <div class="col-lg-2 ml-auto">
               ...
               <div class="col-lg-2 ml-auto">
                <select class="form-control aiz-selectpicker" name="payment_type" id="payment_type">
                    ...
                    @foreach (\App\Models\Order::select('payment_type')->distinct()->get() as $order)
                        <option value="{{ $order->payment_type }}" @if($payment_type == $order->payment_type) selected @endif>
                            {{ translate($order->payment_type) }}
                        </option>
                    @endforeach
              </select>
              </div>

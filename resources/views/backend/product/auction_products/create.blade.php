                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                placeholder="{{ translate('Enter ASIN') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="jan_code" class="form-control" name="jan"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <select id="product_type" class="form-control aiz-selectpicker" name="product_type">
                                    ...
                                    <option value="2">{{translate('Donation')}}</option>
                                    <option value="3">{{translate('Auction')}}</option>
                                </select>
                            </div>
                        </div>  
                    </div>

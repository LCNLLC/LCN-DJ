            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('ASIN') }}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="asin"
                                    placeholder="{{ translate('Enter ASIN') }}" value="{{ $product->asin }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <select id="product_type" class="form-control aiz-selectpicker" name="product_type">
                                    <option value="1" selected>{{translate('Default')}}</option>
                                    <option value="2" <?php if ($product->product_type == 2) echo "selected"; ?> >{{translate('Donation')}}</option>
                                     <option value="3" <?php if ($product->product_type == 3) echo "selected"; ?> >{{translate('Auction')}}</option>
                                </select>
                            </div>
                        </div>  
                    </div>

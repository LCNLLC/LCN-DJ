...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{translate('Donated products')}}</h1>
        </div>
...
<div class="card">
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ translate('Donated products') }}</h5>
            </div>
            ...
            @endcan
              <div class="col-md-2 ml-auto">
               <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" name="published" onchange="sort_products()">
                <option value="">{{ translate('Sort By') }}</option>
                <option value="1" @if(isset($published) && $published == '1') selected @endif>{{translate('Published')}}</option>
                <option value="0" @if(isset($published) && $published == '0') selected @endif>{{translate('Unpublished')}}</option>
            </select>
            </div>
             <div class="col-md-2 ml-auto">

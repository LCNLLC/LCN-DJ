                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-1 pl-0 pt-1">
                                <a href="{{ route('categories.create') }}" class="btn btn-warning btn-icon btn-sm"  title="Add New">
                        ...
                        <div class="form-group row" id="brand">
                            ...
                            <div class="col-md-1 pl-0 pt-1">
                                <a href="{{route('brands.index')}}" class="btn btn-warning btn-icon btn-sm"  title="Add New">
                                    <i class="las la-plus"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="size" step="0.01" value="0.00" placeholder="0.00" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                placeholder="{{ translate('Enter LNC') }}">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('JAN') }} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" id="jan_code" class="form-control" name="jan" maxlength="13" minlength="13" required
                                placeholder="{{ translate('Enter JAN must be exactly 13 characters') }}">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                         ...
                         <div class="form-group row" id="auction_success_price" style="display: none;">
                            <label class="col-md-3 col-from-label">{{translate('Unit price for Bid Acceptance')}} </label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Unit price for Bid Acceptance') }}" name="auction_success_price" class="form-control" >
                            </div>
                        </div>
                        <div id="discount_div">
                            <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Discount') }}" name="discount" id="discount" class="form-control" required>
                         ...
                         <div class="form-group row" id="auction_end_date" style="display: none;">
                               <label class="col-sm-3 control-label" for="start_date">{{translate('Auction End Date')}}</label>
                               <div class="col-sm-9">
                                 <input type="date" class="form-control" name="auction_end_date" placeholder="{{translate('Select Date')}}" value="<?php echo date('Y-m-d', strtotime('+2 days')); ?>">
                            </div>
                         </div>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @elseif(get_setting('shipping_type') == 'product_size_and_area_wise_shipping')
                           <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                           ...
                           <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="warranty_days" placeholder="{{translate('Warranty Days')}}">
                                <div class="input-group-prepend">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="warranty_cost" min="1" step="1" placeholder="{{translate('Warranty Cost')}}">
                                <div class="input-group-prepend">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <select class="form-control aiz-selectpicker" name="tax_type[]" id="percent">
                                    <option value="amount">{{translate('Flat')}}</option>
                                    <option value="percent">{{translate('Percent')}}</option>
                                </select>
                            </div>
...
<script type="text/javascript">
    ...
    $('#jan_code').on('change', function() {
        ...
        $.ajax({
         type:"GET",
         url:'{{ route('products.check_by_jan') }}',
         data:{'id':jan_code},
         success: function(data) {
            console.log(data);
            if(data.message == 'Product found'){
                var productId = data.id;
                var laravelRouteURL = "{{route('products.admin.jan', ['id'=>'PLACEHOLDER_ID'] )}}";
                laravelRouteURL = laravelRouteURL.replace('PLACEHOLDER_ID', productId);
                window.location = laravelRouteURL;
            }
        }
    });

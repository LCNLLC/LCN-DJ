                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    placeholder="{{ translate('Enter JAN') }}" value="{{ $product->jan }}">
                                </div>
                            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body collapse show" id="collapse_2">
                        @if (get_setting('shipping_type') == 'product_wise_shipping' && $product->shipping_type != 'product_size_and_area_wise_shipping')
                        <div class="form-group row">

...
<div class="">
    ...
    @endif
    <form class="form form-horizontal mar-top" action="{{route('products.store.jan')}}" method="POST" enctype="multipart/form-data" id="choice_form">
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Size')}} <small>({{ translate('In cm') }}) <span class="text-danger">*</span></small></label>
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="size" step="0.01" value="{{ $product->size }}" placeholder="0.00" required>
                                 <small class="text-muted">{{translate('Size = Length × Width × Height')}}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('LNC') }}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="asin"
                                    placeholder="{{ translate('Enter LNC') }}" value="{{ $product->asin }}">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('JAN') }}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="jan"
                                    placeholder="{{ translate('Enter JAN') }}" value="{{ $product->jan }}" readonly>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                         ...
                         <div class="form-group row" id="auction_success_price" style=" display: <?php if ($product->product_type == 2 || $product->product_type == 1) echo "none"; ?>">
                                <label class="col-md-3 col-from-label">{{translate('Unit price for Bid Acceptance')}} </label>
                                <div class="col-md-6">
                                    <input type="number" lang="en" min="0"  step="0.01" placeholder="{{ translate('Unit price for Bid Acceptance') }}" name="auction_success_price" class="form-control" value="{{$product->auction_success_price}}">
                                </div>
                            </div>
                        ...
                        @endphp
                        <div id="discount_div" style=" display: <?php if ($product->product_type == 2) echo "none"; ?>"> 
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" lang="en" min="0" step="0.01" placeholder="{{translate('Discount')}}" name="discount" class="form-control" id="discount"  value="{{ $product->discount }}" required>
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="form-group row" id="auction_end_date" style=" display: <?php if ($product->product_type == 2 || $product->product_type == 1) echo "none"; ?>">
                               <label class="col-sm-3 control-label" for="start_date">{{translate('Auction End Date')}}</label>
                               <div class="col-sm-9">
                                 <input type="datetime-local" class="form-control" name="auction_end_date" placeholder="{{translate('Select Date')}}" value="{{ date('Y-m-d\TH:i:s', $product->auction_end_date) }}">
                            </div>
                         </div>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body collapse show" id="collapse_2">
                        ...
                        @elseif(get_setting('shipping_type') == 'product_size_and_area_wise_shipping' && $product->shipping_type == 'product_size_and_area_wise_shipping')
                        <div class="form-group row">
                            <label class="col-md-12 col-from-label">{{translate('Product Size and Area Wise Shipping Cost')}}</label>
                            <div class="col-md-6">
                                <input type="hidden"  name="shipping_type" value="product_size_and_area_wise_shipping">
                            </div>
                        </div>
                        @else
                        <p>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <select id="product_type" class="form-control aiz-selectpicker" name="product_type">
                                    <option value="1" selected>{{translate('New Product')}}</option>
                                    <option value="2" <?php if ($product->product_type == 2) echo "selected"; ?> >{{translate('Donation & Aid')}}</option>
                                     <option value="3" <?php if ($product->product_type == 3) echo "selected"; ?> >{{translate('Used Products')}}</option>
                                </select>
                            </div>
                        </div>  
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                           <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="warranty_status" value="1" @if($product->warranty_status == 1) checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                           <div class="form-group mb-3">
                            <label for="name">
                                {{translate('Warranty Days')}}
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="warranty_days" placeholder="{{translate('Warranty Days')}}" value="{{ $product->warranty_days }}">
                                <div class="input-group-prepend">
                        ...
                        <div class="form-group mb-3">
                            <label for="name">
                                {{translate('Warranty Cost')}}
                            </label>
                            <div class="input-group">
                                <input type="number" class="form-control" name="warranty_cost" min="1" step="1" placeholder="{{translate('Warranty Cost')}}" value="{{ $product->warranty_cost }}">
                                <div class="input-group-prepend">
...
<script type="text/javascript">
    ...
    $('#product_type').on('change', function() {
        ...
        if(product_type == 2)
        {
            ...
            $("#discount").val(100);    
            $("#auction_success_price").hide(); 
        }
        else if(product_type == 3)
        {
            $("#discount_div").show();
            $("#auction_end_date").show(); 
            $("#auction_success_price").show(); 
        }
        else 
        {
          $("#discount_div").show();
          $("#auction_end_date").hide(); 
          $("#auction_success_price").hide(); 
        }
    });

                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <small class="text-muted">
                                    {{ translate('Used for search. Input words by which customers can find this product.') }}
                                </small>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <small class="text-muted">
                                    {{ translate('Use 600x600 images. Visible in product details page gallery.') }}
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="file-preview box sm"></div>
                                <small class="text-muted">
                                    {{ translate('Use 300x300 images. Visible in product box. Keep blank space around main object for responsive cropping.') }}
                                </small>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <small class="text-muted">
                                    {{ translate("Use proper link without extra parameters. Don't use short share link or embed code.") }}
                                </small>
                            </div>
                        </div>
                    ...
                    <div class="w-100">
                        <div class="d-flex my-3">
                            <div class="align-items-center d-flex mar-btm ml-4 mr-5 radio">
                                <input id="fq_brought_select_products"
                                       type="radio"
                                ...
                                <label for="fq_brought_select_products"
                                       class="fs-14 fw-500 mb-0 ml-2">
                                    {{ translate('Select Product') }}
                                </label>
                            </div>
                            <div class="radio mar-btm mr-3 d-flex align-items-center">
                                <input id="fq_brought_select_category"
                                       type="radio"
                                       name="frequently_brought_selection_type"
                                       value="category"
                                       onchange="fq_brought_product_selection_type()">
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-header">
                        ...
                        <h6 class="float-right fs-13 mb-0">
                            ...
                            <span data-toggle="tooltip"
                                  data-placement="top"
                                  title="{{ translate('This will be used for commission based calculations and homepage category wise product Show.') }}">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        @if (get_setting('shipping_type') == 'product_wise_shipping')
                            ...
                            <div class="form-group row">
                                <label class="col-md-6 col-from-label">
                                    {{ translate('Is Product Quantity Mulitiply') }}
                                </label>
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        @else
                            <p>
                                {{ translate('Product wise shipping cost is disabled. Configure shipping from here:') }}
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <p>
                                {{ translate('Cash On Delivery option is disabled. Activate it here:') }}
            ...
            <div class="col-12">
                <div class="btn-toolbar float-right mb-3" role="toolbar">
                    <div class="btn-group mr-2" role="group">
                        <button type="submit" name="button" value="unpublish" class="btn btn-primary">
...
<script type="text/javascript">
    ...
    // Initialize the category tree (if you want the hummingbird plugin styling)
    $(document).ready(function() {
        $("#treeview").hummingbird();
    });

    // Hide/Show shipping cost input if 'flat_rate' is chosen
    ...
    // Frequently Brought: Hide/Show "Select Product" vs. "Select Category"
    ...
    // Filter the product list in the modal
    ...
    // Add selected products from modal to "Frequently Brought" section
    function addFqBroughtProduct() {
        ...
        var productIds = selectedProducts.concat(fqBroughtProductIds.filter(function(item) {
            return selectedProducts.indexOf(item) < 0;
        }));

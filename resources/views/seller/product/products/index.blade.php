                    ...
                    @foreach ($products as $key => $product)
                        <tr>
                            ...
                            <td>
                             ...
                             <td>
                            @if($product->boosting_status == 'InActive')
                               <a href="{{route('seller.boost.plan.add',$product->id)}}" class="btn btn-success" style="padding: 1px 7px 1px 5px;"><i class="lab la-telegram-plane"></i>{{ translate('Add to Boost List')}}</a>
                               @else
                                <a href="#" class="btn btn-success" style="padding: 1px 7px 1px 5px;"><i class="lab la-telegram-plane"></i>{{ translate('Boosting')}}</a>
                                @endif
                            </td>
                            <td class="text-right">

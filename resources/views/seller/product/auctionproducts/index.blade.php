    ...
    <div class="card-body">
        <table class="table aiz-table mb-0">
            ...
            <tbody>
                ...
                <td>
                    <a href="{{route('seller.auction.bids',$product->id)}}"><span class="badge badge-inline badge-danger" style="padding: 12px;">{{ $product->bids_count }}</span></a>
                </td>
                <td>
...
<script type="text/javascript">
    ...
    var bid_product_id = $(el).data('id');
           $.post('{{ route('seller.auction.products.bid') }}', {_token:'{{ csrf_token() }}', id:bid_product_id, status:bid_status_val}, function(data){
            if(data == 1){

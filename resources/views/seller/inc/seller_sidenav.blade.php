            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.products.donated') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.products.donated']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Donation Products') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <!-- Auction -->
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('auction_products.seller.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['auction_products.seller.index', 'seller.auction.bids', 'auction_product_edit.seller', 'product_bids.seller','seller.bid.status']) }}">
                                    <span
                  ...
                  <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            <i class="las la-gavel aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Discount Settting') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller.discount_day.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['seller.discount_day.index', 'seller.discount_day.edit']) }}">
                                    <span
                                        class="aiz-side-nav-text">{{ translate('Discout Days') }}</span>
                                </a>
                            </li>
                ...
                <!-- product boosting -->
                 <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-fighter-jet aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Products Marketing') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.products.boost') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.products.boost']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Boost List') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.boost.plan.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['boost.plan.index','seller.boost.plan.add']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Boosting plan') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('seller.shipping.cost.size') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['seller.shipping.cost.size']) }}">
                        <i class="las la-money-bill aiz-side-nav-icon"></i>

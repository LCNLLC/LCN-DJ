    ...
    <div class="card-body">
        <form class="" action="{{ route('seller.shop.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label class="col-md-2 col-from-label">{{translate('Shop Country')}}<span class="text-danger text-danger">*</span></label>
                <div class="col-md-10">
        ...
        <div class="form-group row">
            <label class="col-md-2 col-from-label">{{translate('shop State')}}<span class="text-danger text-danger">*</span></label>
            <div class="col-md-10">
        ...
        <div class="form-group row">
            <label class="col-md-2 col-from-label">{{translate('Shop City')}}<span class="text-danger text-danger">*</span></label>
            <div class="col-md-10">

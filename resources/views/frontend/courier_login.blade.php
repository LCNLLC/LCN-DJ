...
<div class="h-100 bg-cover bg-center py-5 d-flex align-items-center" style="background-image: url({{ uploaded_asset(get_setting('courier_login_page_bg')) }})">
    <div class="container">
        <div class="row">
                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div class="mb-5 text-center">
                            ...
                            <h5 class="fs-14 fw-400 text-dark">{{ translate('Login To Your Courier Account')}}</h5>
                        </div>

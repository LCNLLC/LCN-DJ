    ...
    <div class="container">
        ...
        <div class="d-flex flex-wrap mb-2 mb-md-3 align-items-baseline justify-content-between">
            ...
            <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                <span class="d-inline-block" style="color: white; background: #831F0C; padding: 10px; border-radius: 2px;">{{ translate('Flash Sale') }}</span>
...
<div id="section_newest">
    ...
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            ...
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between" style="color: #FF7F27; background: #203620; padding: 10px; border-radius: 2px;">
                <!-- Title -->
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                ...
                <div class="d-flex">
                    ...
                    <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="{{ route('search',['sort_by'=>'boosting']) }}">{{ translate('View All') }}</a>
            ...
            <div class="px-sm-3">
                <div class="aiz-carousel arrow-none sm-gutters-16" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                    ...
                    <div class="carousel-box px-3 position-relative has-transition border-right border-top border-bottom @if($key == 0) border-left @endif hov-animate-outline">
                        @include('frontend.partials.product_box_1',['product' => $boosting_product])
                    </div>
                    @endforeach
                </div>
            </div>
...
<div id="section_newest">
    ...
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            ...
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between" style="color:white; background: #dd0612; padding: 10px; border-radius: 2px;">
                <!-- Title -->
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                ...
                <div class="d-flex" style="color:white; background: #dd0612;">
                    ...
                    <a class="text-white fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="{{ route('search',['sort_by'=>'donation']) }}">{{ translate('View All') }}</a>
            ...
            <div class="px-sm-3" >
                <div class="aiz-carousel arrow-none sm-gutters-16" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                    ...
                    <div class="carousel-box px-3 position-relative has-transition border-right border-top border-bottom @if($key == 0) border-left @endif hov-animate-outline">
                        @include('frontend.partials.product_donation',['product' => $donation_product])
                    </div>
                    @endforeach
                </div>
            </div>
...
<section class="mb-2 mb-md-3 mt-2 mt-md-3">
    <div class="container">
        <div class="bg-white">
            <!-- Top Section -->
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between" style="color: black;background: #F1CA02;padding: 10px;border-radius: 2px;">
                <!-- Title -->
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                    <span class="" style="color: black; background: #F1CA02; padding: 10px; border-radius: 2px;">{{ translate('Featured Categories') }}</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="24" viewBox="0 0 16 24" class="ml-3">
                        <path id="Path_28795" data-name="Path 28795" d="M30.953,13.695a.474.474,0,0,0-.424-.25h-4.9l3.917-7.81a.423.423,0,0,0-.028-.428.477.477,0,0,0-.4-.207H21.588a.473.473,0,0,0-.429.263L15.041,18.151a.423.423,0,0,0,.034.423.478.478,0,0,0,.4.2h4.593l-2.229,9.683a.438.438,0,0,0,.259.5.489.489,0,0,0,.571-.127L30.9,14.164a.425.425,0,0,0,.054-.469Z" transform="translate(-15 -5)" fill="#fcc201"/>
                    </svg>
                </h3>
    ...
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            ...
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                ...
                <div class="d-flex">
                    <a type="button" class="arrow-prev slide-arrow link-disable text-secondary mr-2" onclick="clickToSlide('slick-prev','section_newest')"><i class="las la-angle-left fs-20 fw-600"></i></a>
                    <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="{{ route('search',['sort_by'=>'auction']) }}">{{ translate('View All') }}</a>
                    <a type="button" class="arrow-next slide-arrow text-secondary ml-2" onclick="clickToSlide('slick-next','section_newest')"><i class="las la-angle-right fs-20 fw-600"></i></a>
                </div>
            </div>
            <!-- Products Section -->
            <div class="px-sm-3">
                <div class="aiz-carousel arrow-none sm-gutters-16" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                    ...
                    <div class="carousel-box px-3 position-relative has-transition border-right border-top border-bottom @if($key == 0) border-left @endif hov-animate-outline">
                        @include('frontend.partials.product_box_1',['product' => $auction_product])
                    </div>
                    @endforeach
                </div>
            </div>

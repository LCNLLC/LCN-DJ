            ...
            <div class="bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        @if( $detailedProduct->product_type==2)
                           @include('frontend.product_details.donated_product_detail')
                        @elseif( $detailedProduct->product_type==3)
                           @include('frontend.product_details.auction_product_detail')
                        @else

                                            ...
                                            <label class="aiz-megabox d-block bg-white mb-0">
                                                ...
                                                <span class="d-flex p-3 aiz-megabox-elem border-0">
                                                    ...
                                                    <span class="flex-grow-1 pl-3 text-left">
                                                        ...
                                                        <div class="row">
                                                            <span class="fs-14 text-secondary col-3">{{ translate('Delivery Destination') }}:</span>
                                                            <span class="fs-14 text-dark fw-500 ml-2 col">{{ translate($address->delivery_destination) }}</span>
                                                        </div>
                                                          <div class="row">
                                                            <span class="fs-14 text-secondary col-3">{{ translate('Placement Specification') }}:</span>
                                                            <span class="fs-14 text-dark fw-500 ml-2 col">{{ translate($address->placement_specification) }}</span>
                                                        </div>
                                                    </span>
                                                </span>
                                            </label>

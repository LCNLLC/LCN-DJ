...
<div class="card rounded-0 shadow-none border">
    <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group row" >
                <label class="col-lg-2 col-from-label">{{translate('language')}}</label>
                <div class="col-md-10">
                    <select class="form-control aiz-selectpicker" name="language" >
                        <option value="" disabled>{{ translate('Select language') }}</option>
                        @foreach ($langs as $lang)
                        <option value="{{ $lang->code }}" @if($lang->code == Auth::user()->language  ) selected
             ...
             <hr>
               ...
               <h5 class="ml-4 mb-0 h5">{{ translate('Payment Setting')}}</h5>
               <hr>
            <!-- Payment System -->
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="cash_status" type="checkbox" @if (Auth::user()->customer->cash ?? null == 1) checked @endif>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="bank_payment_status" type="checkbox" @if (Auth::user()->customer->bank_payment_status ?? null == 1) checked @endif>
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_name" value="{{ Auth::user()->customer->bank_name ?? null }}" id="bank_name" class="form-control mb-3" placeholder="{{ translate('Bank Name')}}">
                        @error('phone')
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_acc_name" value="{{ Auth::user()->customer->bank_acc_name ?? null }}" id="bank_acc_name" class="form-control mb-3" placeholder="{{ translate('Bank Account Name')}}">
                        @error('bank_acc_name')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_acc_no" value="{{ Auth::user()->customer->bank_acc_no ?? null }}" id="bank_acc_no" class="form-control mb-3" placeholder="{{ translate('Bank Account Number')}}">
                        @error('bank_acc_no')
                        <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="number" name="bank_routing_no" value="{{ Auth::user()->customer->bank_routing_no ?? null }}" id="bank_routing_no" lang="en" class="form-control mb-3" placeholder="{{ translate('Bank Routing Number')}}">
        ...
        <div class="card-body">
            ...
            <div class="">
                <div class="border p-4 mb-4 position-relative">
                    ...
                    <div class="row fs-14 mb-2 mb-md-0">
                        <span class="col-md-2 text-secondary">{{ translate('Delivery Destination') }}:</span>
                        <span class="col-md-10 text-dark">{{ translate($address->delivery_destination) }}</span>
                    </div>
                    <div class="row fs-14 mb-2 mb-md-0">
                        <span class="col-md-2 text-secondary text-secondary">{{ translate('Placement Specification') }}:</span>
                        <span class="col-md-10 text-dark">{{ translate($address->placement_specification) }}</span>
                    </div>

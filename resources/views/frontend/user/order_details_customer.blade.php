            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <table class="table-borderless table">
                        ...
                        @endif
                        @if ($order->tracking_website_url)
                            <tr>
                                <td class="w-50 fw-600">{{ translate('Tracking Website URL') }}:</td>
                                <td><a href="{{ $order->tracking_website_url }}" target="_blank">{{ translate('Track your Delivery')}}</a></td>
                            </tr>
                        @endif
                    </table>
                </div>

...
<div class="aiz-card-box h-auto bg-white py-3 hov-scale-img">
    <div class="position-relative h-140px h-md-200px img-fit overflow-hidden">
        ...
        @if (discount_in_percentage($product) > 0 && $product->product_type == 1)
        ...
        @elseif (discount_in_percentage($product) > 0 &&  $product->product_type == 2)
         <span class="absolute-top-left bg-danger ml-1 mt-1 fs-11 fw-700 text-white w-70px text-center"

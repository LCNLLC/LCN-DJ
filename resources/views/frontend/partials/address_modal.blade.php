                ...
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control aiz-selectpicker rounded-0" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="delivery_destination">
                                        <option value="">{{ translate('Select your destination') }}</option>
                                        <option value="house">{{ translate('House') }}</option>
                                        <option value="complex">{{ translate('Complex') }}</option>
                                        <option value="building">{{ translate('Building') }}</option>
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="placement_specification" id="entrance_door" value="entrance_door">
                                        <label class="form-check-label" for="entrance_door">{{ translate('At the Entrance Door') }}</label>
                                    </div>
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="placement_specification" id="delivery_box" value="delivery_box">
                                        <label class="form-check-label" for="delivery_box">{{ translate('Delivery Box') }}</label>
                                    </div>
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="placement_specification" id="gas_meter_box" value="gas_meter_box">
                                        <label class="form-check-label" for="gas_meter_box">{{ translate('Gas Meter Box') }}</label>
                                    </div>
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="placement_specification" id="bicycle_basket" value="bicycle_basket">
                                        <label class="form-check-label" for="bicycle_basket">{{ translate('Bicycle Basket') }}</label>
                                    </div>
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="placement_specification" id="garage" value="garage">
                                        <label class="form-check-label" for="garage">{{ translate('Garage') }}</label>
                                    </div>
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="placement_specification" id="receptionist_manager" value="receptionist_manager">
                                        <label class="form-check-label" for="receptionist_manager">{{ translate('Receptionist/Building Manager') }}</label>
                                    </div>
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="placement_specification" id="hand_delivery" value="hand_delivery">
                                        <label class="form-check-label" for="hand_delivery">{{ translate('Hand delivery') }}</label>
                                    </div>
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="placement_specification" id="neighbors" value="neighbors">
                                        <label class="form-check-label" for="neighbors">{{ translate('Neighbors') }}</label>
                                    </div>
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="placement_specification" id="none_of_these" value="none_of_these">

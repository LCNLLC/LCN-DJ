    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-lg-6 text-center text-lg-left">
                {{-- <h1 class="fw-700 fs-24 text-dark">{{ translate('Courier Registration')}}</h1> --}}
            </div>
            <div class="col-lg-6">
                <ul class="breadcrumb bg-transparent p-0 justify-content-center justify-content-lg-end">
                    ...
                    <li class="text-dark fw-600 breadcrumb-item">
                        "{{ translate('Courier Registration')}}"
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <h1 class="fw-700 fs-20 fs-md-24 text-dark text-center mb-3">{{ translate('Courier Registration')}}</h1>
                <form id="shop" class="" action="{{ route('couriers.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if (!Auth::check())
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary fw-600 rounded-0">{{ translate('Register')}}</button>
                    </div>
                </form>
            </div>
        </div>

    ...
    <div class="d-flex flex-wrap align-items-center mb-3">
        ...
        <div class="d-flex flex-wrap align-items-center">
            <div class="d-flex align-items-center mr-4">
                ...
                <span class="text-secondary fs-14 fw-400 mr-4 w-75px">{{ translate('Donated by') }}</span>
    ...
    <div class="row no-gutters mb-3">
        ...
        <div class="col-sm-10">
            <div class="d-flex align-items-center">
                ...
                <span class="bg-danger ml-2 fs-11 fw-700 text-white w-135px text-center p-1"
                style="padding-top:2px;padding-bottom:2px;">{{ translate('100% Free') }}</span>
                @endif
                <!-- Club Point -->
...
<div class="row no-gutters mb-3">
    ...
    <div class="col-sm-10 mt-2">
        <div class="product-quantity d-flex align-items-center">
            <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="display: none;">
...
<div class="row no-gutters pb-3 d-none" id="chosen_price_div">
   ...
   <div class="col-sm-2">
        <div class="text-secondary fs-14 fw-400 mt-2">{{ translate('Note') }}</div>
    </div>
     <div class="col-sm-8">
        <div class="text-secondary fs-14 fw-400 mt-2">{{ translate('If you want this product, message to Seller or Donor.') }}</div>
    </div>

<div class="text-left">
    ...
    @if ($detailedProduct->auction_product != 1)
        <form id="option-choice-form">
            ...
            <!-- warranty -->
            @if ($detailedProduct->warranty_status == 1)
                <div class="row no-gutters mb-3">
                    <div class="col-sm-2" style="text-align: center;">
                            <input type="checkbox" name="warranty" value="1" style="height: 29px !important; width: 29px !important;">
                        </div>
                        <div class="col-sm-10">
                            <div class="text-secondary fs-14 fw-400 mt-2">{{$detailedProduct->warranty_days}} {{ translate('Days Warranty Support') }}</div>
                    </div>
                </div>
            @endif

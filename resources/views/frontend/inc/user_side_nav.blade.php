    ...
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <!-- bidlist -->
                <li class="aiz-side-nav-item">
                    <a href="{{ route('customer.bid-products') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['customer.bid-products']) }}">
                        <i class="las la-gavel aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Bidlist') }}</span>
                    </a>
                </li>
                ...
                @if ((addon_is_activated('affiliate_system')))
                    <li class="aiz-side-nav-item" >
                        <a href="javascript:void(0);"
                            class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.user.index','user.money_withdraw_requests.index','user.referrl.role','user.money_withdraw_requests.index']) }}">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                           <!--  <li class="aiz-side-nav-item">
                              ...
                              <li class="aiz-side-nav-item">
                                <a href="{{route('user.referrl.role')}}" class="aiz-side-nav-link {{ areActiveRoutes(['user.referrl.role']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Referales') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('user.money_withdraw_requests.index') }}"
                                    class="aiz-side-nav-link">
                                    <span
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('idea.index') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['idea.index', 'idea.show']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16.001" viewBox="0 0 16 16.001">
                            <g id="Group_24764" data-name="Group 24764" transform="translate(-316 -1066)">
                                <path id="Subtraction_184" data-name="Subtraction 184" d="M16427.109,902H16420a8.015,8.015,0,1,1,8-8,8.278,8.278,0,0,1-1.422,4.535l1.244,2.132a.81.81,0,0,1,0,.891A.791.791,0,0,1,16427.109,902ZM16420,887a7,7,0,1,0,0,14h6.283c.275,0,.414,0,.549-.111s-.209-.574-.34-.748l0,0-.018-.022-1.064-1.6A6.829,6.829,0,0,0,16427,894a6.964,6.964,0,0,0-7-7Z" transform="translate(-16096 180)" fill="#b5b5bf"/>
                                <path id="Union_12" data-name="Union 12" d="M16414,895a1,1,0,1,1,1,1A1,1,0,0,1,16414,895Zm.5-2.5V891h.5a2,2,0,1,0-2-2h-1a3,3,0,1,1,3.5,2.958v.54a.5.5,0,1,1-1,0Zm-2.5-3.5h1a.5.5,0,1,1-1,0Z" transform="translate(-16090.998 183.001)" fill="#b5b5bf"/>
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Evolution Idea') }}</span>
                        @if ($idea > 0)
                            <span class="badge badge-inline badge-success">{{ $idea }}</span>
                        @endif
                    </a>
                </li>
                     <!-- Manage Profile -->
            ...
            <!--       <li class="aiz-side-nav-item">
                    <a href="{{ route('job.profile') }}" class="aiz-side-nav-link {{ areActiveRoutes(['job.profile']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <g id="Group_8094" data-name="Group 8094" transform="translate(3176 -602)">
                              <path id="Path_2924" data-name="Path 2924" d="M331.144,0a4,4,0,1,0,4,4,4,4,0,0,0-4-4m0,7a3,3,0,1,1,3-3,3,3,0,0,1-3,3" transform="translate(-3499.144 602)" fill="#b5b5bf"/>
                              <path id="Path_2925" data-name="Path 2925" d="M332.144,20h-10a3,3,0,0,0,0,6h10a3,3,0,0,0,0-6m0,5h-10a2,2,0,0,1,0-4h10a2,2,0,0,1,0,4" transform="translate(-3495.144 592)" fill="#b5b5bf"/>
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Manage Job Profile') }}</span>
                    </a>
                </li> -->
...
{{--                            </g>--}}
{{--                        </svg>--}}
{{--                            <span class="aiz-side-nav-text ml-3">{{ 'Refer to other' }}</span>--}}
{{--                    </a>--}}
{{--                </li>--}}

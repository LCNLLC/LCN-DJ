...
<section class="py-3 text-light footer-widget border-bottom" style="border-color: #13263B !important; background-color: #212129 !important;">
    <div class="container">
        <!-- footer logo -->
        <div class="mt-3 mb-2 text-left orrange-border pb-1">
...
@php
    $col_values = ((get_setting('vendor_system_activation') == 1) || addon_is_activated('delivery_boy')) ? "col-lg-2 col-md-6 col-sm-6" : "col-md-4 col-sm-6";
@endphp
        ...
        <div class="row justify-content-center">
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
					...
					<img src="https://lacuna.me/public/uploads/all/qrcode-lacuna.jpg" width="120" />
            ...
            <!-- My Account -->
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4 footer-list">
                    <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3 orrange-border pb-1">{{ translate('My Account') }}</h4>
                    <ul class="list-unstyled">
                        @if (Auth::check())
                            <li class="mb-2">
                                <span style="background-color:#13263B; padding:5px; padding-left:8px; padding-left:8px; margin-right:10px;">
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4 footer-list">
                    <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3 orrange-border pb-1">{{ translate('About us') }}</h4>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <span style="background-color:#13263B; padding:5px; padding-left:8px; padding-left:8px; margin-right:10px;">
                                <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" width="8" height="12" viewBox="0 0 8 12">
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-soft-light animate-underline-white" href="{{ route('faq') }}">
                                {{ translate("FAQ's") }}
                            </a>
                        </li>
                    </ul>
            ...
            <!-- Top sellers -->
            <!-- Top sellers -->
            <div class="{{ $col_values }}" style="display: none">
                <div class="text-center text-sm-left mt-4 footer-list">
                    <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3 orrange-border pb-1">{{ translate('Top Sellers') }}</h4>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <span style="background-color:#13263B; padding:5px; padding-left:8px; padding-left:8px; margin-right:10px;">
                                <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" width="8" height="12" viewBox="0 0 8 12">
                            ...
                            <a class="fs-13 text-soft-light animate-underline-white whitespace-nowrap" style="whitespace: nowrap;" href="shop/Demo-Seller-Shop-1">
                                <i class="fa-solid fa-wand-magic-sparkles pr-1" style="color:#FF7F27;"></i>
                                {{ translate('Demo Seller Shop') }}
                            </a>
                        </li>
                        <li class="mb-2">
                            <span style="background-color:#13263B; padding:5px; padding-left:8px; padding-left:8px; margin-right:10px;">
            ...
            <!-- quick links -->
             ...
             <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4 footer-list">
                    <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3 orrange-border pb-1">{{ translate('Quick Links') }}</h4>
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-soft-light animate-underline-white whitespace-nowrap" style="whitespace: nowrap;" href="{{ route('search',['sort_by'=>'donation']) }}">

                                {{ translate('Donation & Aid') }}
                            </a>
                        </li>
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-soft-light animate-underline-white whitespace-nowrap" style="whitespace: nowrap;" href="{{ route('search',['sort_by'=>'auction']) }}">

                                {{ translate('Used Products') }}
                            </a>
                        </li>
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-soft-light animate-underline-white whitespace-nowrap" style="whitespace: nowrap;" href="{{route('jobs')}}">
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-soft-light animate-underline-white whitespace-nowrap" style="whitespace: nowrap;" href="{{route('candidates')}}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="text-center text-sm-left mt-4 footer-list">
                    ...
                    @if (get_setting('vendor_system_activation') == 1)
                        <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3 orrange-border pb-1">{{ translate('Seller Zone') }}</h4>
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <span style="background-color:#13263B; padding:5px; padding-left:8px; padding-left:8px; margin-right:10px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" width="8" height="12" viewBox="0 0 8 12">
                                ...
                                <a class="fs-13 text-soft-light mb-0">
                        ...
                        <!--     <li>
                                ...
                                <button type="button" class="btn btn-primary rounded-0 w-100" data-toggle="modal" data-target="#myModal">Subscribe</button>
                            </li> -->
                            <!-- popup-model -->
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="fs-14 fw-700 text-dark">{{ translate('Subscribe to our newsletter for regular updates about Offers, Coupons & more') }}</h5>
                                            <!-- <button type="button" class="close" data-dismiss="modal">&times;</button> -->
                                        </div>

                                        <div class="col-xl-6 col-lg-7" style="max-width:90%; margin:auto;">
                                            <div class="mb-4 text-secondary text-justify">
                                                {!! get_setting('about_us_description',null,App::getLocale()) !!}
                                            </div>
                                            <div class="mb-3">
                                                <form method="POST" action="{{ route('subscribers.store') }}">
                                                    ...
                                                    <div class="row gutters-10">
                                                        <div class="col-8">
                                                            <input type="email" class="form-control border-secondary rounded-0 w-100 bg-transparent" placeholder="{{ translate('Your Email Address') }}" name="email" required>
                                                        </div>
                                                        <div class="col-4">
                                                            <button type="submit" class="btn btn-primary rounded-0 w-100">{{ translate('Send') }}</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
    ...
    <div class="d-lg-none bg-transparent">
        ...
        <div class="aiz-accordion-wrap bg-black">
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
					<center><img src="https://lacuna.me/public/uploads/all/qrcode-lacuna.jpg" width="120" style=" margin-top: 15px;margin-bottom: 15px;" /></center>
        ...
        <!-- top seller -->
        <div class="aiz-accordion-wrap bg-black" style="display: none;">
            <div class="aiz-accordion-heading container bg-black">
                <button class="aiz-accordion fs-14 text-white bg-transparent">{{ translate('Top Sellers') }}</button>
            </div>
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
        ...
        <div class="aiz-accordion-wrap bg-black">
            <div class="aiz-accordion-heading container bg-black">
                <button class="aiz-accordion fs-14 text-white bg-transparent">{{ translate('Quick Links') }}</button>
            </div>
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
                        ...
                        <li>
                            <p>Subscribe to our newsletter</p>
                            <button type="button" class="btn btn-primary rounded-0 w-100" data-toggle="modal" data-target="#subscribe">Subscribe</button>
                        </li>
                        <!-- popup-model -->

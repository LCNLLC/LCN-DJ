...
@section('content')
                        ...
                        <div class="card rounded-0 border shadow-none">
                            ...
                            <div class="pt-3 px-4 fs-14">
                                <label class="aiz-checkbox">
                                    <input type="checkbox" required id="agree_checkbox" name="agree_checkbox">
    ...
    if (isset($error) && count($error) > 0){
        flash('error: ' . $error[0])->error()->important();
    }
    @endphp
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="termsModalLabel">{{ translate('Terms and Conditions') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="terms-modal-content" >
                    {!! $termsContent->getTranslation('content') !!}
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ translate('agree') }}</button>
                </div>
            </div>
        </div>
    </div>

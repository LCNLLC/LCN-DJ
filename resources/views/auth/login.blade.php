                ...
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <form class="pad-hor" method="POST" role="form" action="{{ route('login') }}">
                            ...
                            <button  onclick="this.form.submit(); this.disabled=true; this.innerHTML='<span class=\'spinner-border spinner-border-sm\' role=\'status\' aria-hidden=\'true\'></span> {{ translate('Please wait...') }}';" type="submit" class="btn btn-primary btn-lg btn-block">
                                {{ translate('Login') }}
                            </button>
                            <div class="mt-3">
                                {{translate('Do not have an account')}} ? <a href="{{route('register')}}" class="btn-link mar-rgt text-bold">{{translate('Sign Up')}}</a>
                            </div>
                        </form>

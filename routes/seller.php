...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(ShippingCostSizeController::class)->group(function () {
        Route::get('/seller/shipping/cost/size', 'showShippingDetailsToseller')->name('shipping.cost.size');
    });
});
...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('/products/boosting', 'boost_product')->name('products.boost');
        Route::get('/products/donations', 'donation_products')->name('products.donated');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::post('/orders/update_tracking_details', 'update_tracking_details')->name('orders.update_tracking_details');
    });
    ...
    // Product Boost
    Route::controller(ProductBoostController::class)->group(function () {
        Route::get('/boosting-plan/{id}', 'add_plan')->name('boost.plan.add');
        Route::get('/boosting-plan', 'index')->name('boost.plan.index');

    });

    // Product Boost payment
    Route::controller(PaymentController::class)->group(function () {
        Route::post('/pay-with', 'PaymentMethod')->name('buy.plan');

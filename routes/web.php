...
Route::controller(CronController::class)->group(function () {
    Route::get('/cron/support_ticket/delete', 'delete_old_support_tickets');
    Route::get('/cron/daily', 'daily');

    Route::get('/products/low-stock/daily', 'all_products')->name('products.notify');
    Route::get('/products/adversment/daily', 'products_adversment')->name('products.adversment');
    Route::get('/jobs/adversment/daily', 'jobs_adversment')->name('jobs.adversment');
    Route::get('/auction-end-notification/every-15mint', 'auction_end_notification')->name('auction.end.notification');
    Route::get('/seller-approved/daily', 'approvedSeller')->name('approved.seller');
    //https://localhost/llacuna.me/auction-end-notification/every-15mint
    //https://localhost/llacuna.me/seller-approved/daily
});
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/referral/user', 'referred')->name('user.referred');
    Route::get('/referral/commission', 'refComIndex')->name('user.referral.com');
    Route::post('/referral/commission/adjust', 'refComAdjust')->name('user.referral.com.adjust');
    ...
    Route::get('/courier/login', 'login')->name('courier.login');
...
Route::controller(SearchController::class)->group(function () {
    ...
    Route::post('/faq-ajax-search', 'faq_ajax_search')->name('faq.search.ajax');
    Route::get('/faq/search/{keyword}', 'faq_search')->name('faq.search');
});
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::controller(HomeController::class)->group(function () {
        ...
        Route::get('job/profile', 'jobProfile')->name('job.profile');

        Route::post('job/profile/save', 'jobProfileSave')->name('job.profile.save');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function () {
    ...
    Route::controller(ReferralController::class)->group(function () {
         Route::get('/referral/role', 'index')->name('user.referrl.role');
    ...
    Route::controller(CustomerPaymentController::class)->group(function () {
        Route::get('/money-withdraw-requests', 'index')->name('user.money_withdraw_requests.index');
        Route::post('/money-withdraw-request/store', 'store')->name('user.money_withdraw_request.store');
         Route::get('/money-withdraw-history', 'payment_history')->name('user.payment_history');
    });
    ...
    Route::controller(AuctionProductController::class)->group(function () {
        Route::get('/customer/bid-products', 'showBidProducts')->name('customer.bid-products');
    });
    //Follow
    ...
    Route::post('idea/reply', [IdeaController::class, 'seller_store'])->name('idea.seller_store');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::controller(MessageController::class)->group(function () {
        Route::get('/messages/destroy/{id}', 'destroy')->name('messages.destroy');
    });
    //Address
    ...
    Route::controller(AddressController::class)->group(function () {
        ...
        Route::post('/get-all-states', 'getAllStates')->name('get-all-state');
        Route::post('/get-all-cities', 'getAllCities')->name('get-all-city');
...
Route::controller(ApplicationController::class)->group(function () {
    Route::get('/job/apply/{id}', 'index')->name('apply');
    Route::get('/job/quick-apply/{id}', 'quickApply')->name('quick.apply');
    Route::post('/apply/job', 'store')->name('apply.job');
});
...
Route::controller(JobController::class)->group(function () {
    Route::get('/job', 'all_job')->name('jobs');
    Route::get('/job/{slug}', 'job_details')->name('job.details');
});

Route::controller(CandidateController::class)->group(function () {
    Route::get('/candidate', 'all_candidate')->name('candidates');
    Route::get('/candidate/{slug}', 'candidate_details')->name('candidate.details');
});

...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::controller(AuctionProductController::class)->group(function () {
        ...
        Route::get('/auction-product/create', 'create')->name('auction_product_create.admin');
        Route::get('auction/seller-products', 'seller_auction_products')->name('auction.seller_products');
        Route::get('auction/product/bis/{id}', 'bid')->name('auction.bids');
        Route::post('products/bid', 'bidProductStatus')->name('auction.products.bid');
        Route::post('auction/products/bid', 'bidStatus')->name('bid.status');
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user']], function() {
    Route::controller(AuctionProductController::class)->group(function () {
        ...
        Route::post('auction/products/bid', 'bidProductStatusSeller')->name('seller.auction.products.bid');
        Route::get('auction/seller-product/bis/{id}', 'seller_bid')->name('seller.auction.bids');
        Route::post('bid/status', 'SellerBidStatus')->name('seller.bid.status');
    ...
    Route::controller(AuctionProductBidController::class)->group(function () {
        ...
        Route::get('/seller/product-bids/destroy/{id}', 'bid_destroy_admin')->name('product_bids_destroy.seller');
    });
});
